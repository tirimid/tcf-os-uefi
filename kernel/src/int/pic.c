...
{
        uint8_t mask_1 = io_cpu_read_port_byte(IO_CPU_PORT_PIC1_DATA);
        uint8_t mask_2 = io_cpu_read_port_byte(IO_CPU_PORT_PIC2_DATA);
        ...
        io_cpu_write_port_byte(IO_CPU_PORT_PIC1_DATA, mask_1);
        io_cpu_write_port_byte(IO_CPU_PORT_PIC2_DATA, mask_2);
}

void int_pic_mask(uint8_t pic1_mask, uint8_t pic2_mask)
{
        io_cpu_write_port_byte(IO_CPU_PORT_PIC1_DATA, pic1_mask);
        io_cpu_write_port_byte(IO_CPU_PORT_PIC2_DATA, pic2_mask);
}
